...
import py.pol.una.ii.pw.service.CompraCarritoRegistration;
...
@Path("/compras")
@RequestScoped
public class CompraCarritoResourceRESTService {
    @Inject
    private Logger log;
    ...
    @Inject
    CompraCarritoRegistration registration;
    ...
    public Response createCompra(Compra compra) {
        ...
        try {
            ...
            CompraCarritoRegistration bean = (CompraCarritoRegistration) request.getSession().getAttribute("compra");
            ...
            if(bean == null){
                ...
                try {
                    ...
                    bean = (CompraCarritoRegistration)
                            ic.lookup("java:global/EjbJaxRS-ear/EjbJaxRS-ejb/CompraCarritoRegistration");
